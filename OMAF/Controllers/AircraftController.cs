...
namespace OMAF.Controllers
{
    public class AircraftController : Controller
    {
        ...
        public async Task<IActionResult> Index3(string id)                 //Add Search
        {
            ...
            {
                aircraft = aircraft.Where(s => s.SysReason.Contains(id));
            }

            return View(await aircraft.ToListAsync());
        }
        public async Task<IActionResult> Index2(string searchString)                 //Add Search
        {
            var aircraft = from m in _context.Aircraft
                         select m;
        ...
        public async Task<IActionResult> Create([Bind("Id,SysReason,InitiateDate,BUNO,UDP")] Aircraft aircraft)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SysReason,InitiateDate,BUNO,UDP")] Aircraft aircraft)
        {
            if (id != aircraft.Id)
            {
                return NotFound();
